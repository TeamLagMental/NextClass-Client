...
import { adminRoutes } from '../../routes/RoutesDashboard'
...
const DAdminLayout = () => {
  ...
  const getRoutes = (
    <Switch>
      {adminRoutes.items.map((item, index) =>
        item.type === "external" ? (
          <Route
            exact
            path={item.path}
  ...
  <>
    ...
    <div className={classNames(classes.panel, "theme-dark")}>
      <Sidebar routes={adminRoutes.items} opened={opened} toggleDrawer={handleDrawerToggle}/>
